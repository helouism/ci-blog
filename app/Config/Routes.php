...
$routes->get("search", "Search::index", ["as" => "search_results"]);
...
$routes->group("admin", ["filter" => "group:admin"], static function ($routes) {
    ...
    $routes->post("posts/image/process", "Admin\PostController::processImage", [
        "as" => "admin_posts_image_process",
    ]);
    $routes->post("posts/image/revert", "Admin\PostController::revertImage", [
        "as" => "admin_posts_image_revert",
    ]);
    ...
    $routes->post("pages/delete/(:num)", 'Admin\PageController::delete/$1', [
        "as" => "admin_pages_delete",
    ]);

    // Profile Management Routes
    $routes->get("profile", "Admin\Profile::index", ["as" => "admin_profile"]);
    $routes->post("profile/bio", "Admin\Profile::updateBio", [
        "as" => "admin_profile_update_bio",
    ]);

    $routes->get("profile/change-email", "Admin\Profile::changeEmail", [
        "as" => "admin_profile_change_email",
    ]);
    $routes->post("profile/update-email", "Admin\Profile::updateEmail", [
        "as" => "admin_profile_update_email",
    ]);
    $routes->get("profile/email/verify", "Admin\Profile::verifyEmailChange", [
        "as" => "admin_profile_verify_email_change",
    ]);
    $routes->get("profile/change-username", "Admin\Profile::changeUsername", [
        "as" => "admin_profile_change_username",
    ]);
    $routes->post("profile/update-username", "Admin\Profile::updateUsername", [
        "as" => "admin_profile_update_username",
    ]);
    $routes->get("profile/change-password", "Admin\Profile::changePassword", [
        "as" => "admin_profile_change_password",
    ]);
    $routes->post("profile/update-password", "Admin\Profile::updatePassword", [
        "as" => "admin_profile_update_password",
    ]);
});
